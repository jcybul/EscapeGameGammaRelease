...
public class GammaEscapeGameTest
{
	...
	//SQUARE GAME
	@Test
    void SquareGamePlayer1Wins() throws Exception
    {
        EscapeGameBuilder egb 
            = new EscapeGameBuilder(new File("config/Final/SquareGame.xml"));
        EscapeGameManager emg = egb.makeGameManager();
	...
	@Test
    void SquareGamePlayer2Wins() throws Exception
    {
        EscapeGameBuilder egb 
            = new EscapeGameBuilder(new File("config/Final/SquareGame2.xml"));
        EscapeGameManager emg = egb.makeGameManager();
        assertTrue(emg instanceof SquareGame);  
        ObserverTest ot = new ObserverTest();
        emg.addObserver(ot);
	...
	@Test
    void SquareGamePointConlflict() throws Exception
    {
        EscapeGameBuilder egb 
            = new EscapeGameBuilder(new File("config/Final/SquareGame3.xml"));
        EscapeGameManager emg = egb.makeGameManager();
        assertTrue(emg instanceof SquareGame);  
        ObserverTest ot = new ObserverTest();
        emg.addObserver(ot);
	...
	@Test
    void SquareGameTiedGame() throws Exception
    {
        EscapeGameBuilder egb 
            = new EscapeGameBuilder(new File("config/Final/SquareGame4.xml"));
        EscapeGameManager emg = egb.makeGameManager();
        assertTrue(emg instanceof SquareGame);  
        ObserverTest ot = new ObserverTest();
        emg.addObserver(ot);
