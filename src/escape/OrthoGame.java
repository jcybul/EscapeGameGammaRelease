 ...
 * @version 28 abr. 2020
 */
public class OrthoGame extends Game
		implements EscapeGameManager<OrthoSquareCoordinate>
{
	...
	public OrthoGame(HashMap<PieceName, PieceTypeInitializer> PieceTypes,
			HashMap<RuleID, Rule> gameRules, OrthoBoard b)
	{
	 ...
	 * @return
	 */
	public void destEqualsFrom(OrthoSquareCoordinate from, OrthoSquareCoordinate to)
	{
	 ...
	 * @param to
	 */
	public void destIsBlocked(OrthoSquareCoordinate to)
	{
	 ...
	 * @param to
	 */
	public void attackAlly(OrthoSquareCoordinate from, OrthoSquareCoordinate to)
	{
	 ...
	 */
	public void removeOrConflict(OrthoSquareCoordinate to)
	{
		if (b.getPieceAt(to) != null) {
			if (gameRules == null || !gameRules.containsKey(RuleID.REMOVE)
					&& !gameRules.containsKey(RuleID.POINT_CONFLICT)) {
	 ...
	 * @param from
	 */
	public void emptyFromLocation(OrthoSquareCoordinate from)
	{
	 ...
	 * @param from
	 */
	public void turnCheck(OrthoSquareCoordinate from)
	{
		if (turnHolder % 2 != 0
