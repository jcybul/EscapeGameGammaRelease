...
public class HexGame extends Game implements EscapeGameManager<HexCoordinate>
{
	...
	public HexGame(HashMap<PieceName, PieceTypeInitializer> PieceTypes,
			HashMap<RuleID, Rule> gameRules, HexBoard b)
	{
	...
	public boolean move(HexCoordinate from, HexCoordinate to)
	{
		...
		MovementPatternID pattern = ((PieceTypeInitializer) this.PieceTypes
